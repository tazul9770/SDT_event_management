...
from user.views import ProfileView, LoginUser, ChangePassword, CustomPasswordResetView, CustomPasswordResetConfirmView, EditProfileView, CustomPasswordResetDoneView, CustomPasswordResetCompleteView
